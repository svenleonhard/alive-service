...
/**
 * Criteria class for the {@link de.svenleonhard.alive.domain.RegisterMessage} entity. This class is used
 * in {@link de.svenleonhard.alive.web.rest.RegisterMessageResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /register-messages?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class RegisterMessageCriteria implements Serializable, Criteria {
    ...
    public RegisterMessageCriteria() {}

    public RegisterMessageCriteria(RegisterMessageCriteria other) {
    ...
    @Override
    public RegisterMessageCriteria copy() {
        return new RegisterMessageCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final RegisterMessageCriteria that = (RegisterMessageCriteria) o;
        return (
    ...
    public String toString() {
        return "RegisterMessageCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
