...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, de.svenleonhard.alive.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, de.svenleonhard.alive.repository.UserRepository.USERS_BY_EMAIL_CACHE);
