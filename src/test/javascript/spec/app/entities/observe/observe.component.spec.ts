...
import { ObserveComponent } from 'app/entities/observe/observe.component';
import { ObserveService } from 'app/entities/observe/observe.service';
import { Observe } from 'app/shared/model/observe.model';

describe('Component Tests', () => {
  describe('Observe Management Component', () => {
    let comp: ObserveComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ObserveComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.observes && comp.observes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
