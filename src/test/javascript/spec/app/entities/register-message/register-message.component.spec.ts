...
import { RegisterMessageComponent } from 'app/entities/register-message/register-message.component';
...
describe('Component Tests', () => {
  describe('RegisterMessage Management Component', () => {
    let comp: RegisterMessageComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RegisterMessageComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.registerMessages && comp.registerMessages[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
